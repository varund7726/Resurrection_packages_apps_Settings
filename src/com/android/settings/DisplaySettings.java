...
public class DisplaySettings extends SettingsPreferenceFragment implements
  ...
  boolean configEnableLockRotation = getResources().
    ...
    private void updateState() {
        ...
        if (mScreenshotCropAndSharePreference != null) {
            int value = Settings.System.getInt(getContentResolver(), SCREENSHOT_CROP_AND_SHARE, 0);
            mScreenshotCropAndSharePreference.setChecked(value != 0);
        }

 	if (mScreenshotCropBehaviorPreference != null) {
            int value = Settings.System.getInt(getContentResolver(), SCREENSHOT_CROP_BEHAVIOR, 0);
